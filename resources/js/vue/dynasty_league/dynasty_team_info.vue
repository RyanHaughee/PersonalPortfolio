...
<template>
     <div class="container team-row border-a" v-for="(team, index) in teams" :key="team" @click="toggle_index(index)" style="max-width:100%">
        <div class="row">
            ...
            <div class="col-sm-5" style="white-space: nowrap; text-align:right">
                <table class="rating-table float-r">
                    <tr>
                ...
                <table class="rating-table float-r">
                    <tr>
                        <td class="border-a" style="height:25px; width:50px">
                            <span style="font-size:14px; font-weight:600">2022</span>
                        </td>
                    </tr>
                    <tr>
                        <td style="height:50px; width:50px">
                            <div style="font-size:16px">TBD</div>
                            <div style="font-size:10px">#XX | (0)</div>
                        </td>
                    </tr>
                </table>
                <table class="rating-table float-r">
                    <tr>
                        <td class="border-a" style="height:25px; width:75px">
